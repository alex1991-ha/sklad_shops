  ...
  <div id="popupСollect">
    <div id="popup_body">
      <form action="php_script/сollect.php" method="POST" id="formСollect">
        <p>Введите количество ip-камер: <input type="number" id="" name="camers" value="4" min="1" max="100"></p>
        <p>Введите количество клавиатур: <input type="number" id="" name="keyboard" value="2" min="1" max="100"></p>
